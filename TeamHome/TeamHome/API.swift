...
public final class SubscribeToDocumentMutation: GraphQLMutation {
  public let operationDefinition =
    "mutation SubscribeToDocument($documentID: ID!) {\n  subscribeDoc(input: {id: $documentID}) {\n    __typename\n    _id\n  }\n}"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("subscribeDoc", arguments: ["input": ["id": GraphQLVariable("documentID")]], type: .object(SubscribeDoc.selections)),
    ]
    ...
    public init(subscribeDoc: SubscribeDoc? = nil) {
      self.init(unsafeResultMap: ["__typename": "Mutation", "subscribeDoc": subscribeDoc.flatMap { (value: SubscribeDoc) -> ResultMap in value.resultMap }])
    }

    public var subscribeDoc: SubscribeDoc? {
      get {
        return (resultMap["subscribeDoc"] as? ResultMap).flatMap { SubscribeDoc(unsafeResultMap: $0) }
      }
      set {
        resultMap.updateValue(newValue?.resultMap, forKey: "subscribeDoc")
      }
    }

    public struct SubscribeDoc: GraphQLSelectionSet {
      public static let possibleTypes = ["Document"]
      ...
      public init(id: GraphQLID? = nil) {
        self.init(unsafeResultMap: ["__typename": "Document", "_id": id])
      }
...
public final class UnsubscribeFromDocumentMutation: GraphQLMutation {
  public let operationDefinition =
    "mutation UnsubscribeFromDocument($documentID: ID!) {\n  unsubscribeDoc(input: {id: $documentID}) {\n    __typename\n    _id\n  }\n}"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static let selections: [GraphQLSelection] = [
      GraphQLField("unsubscribeDoc", arguments: ["input": ["id": GraphQLVariable("documentID")]], type: .object(UnsubscribeDoc.selections)),
    ]
    ...
    public init(unsubscribeDoc: UnsubscribeDoc? = nil) {
      self.init(unsafeResultMap: ["__typename": "Mutation", "unsubscribeDoc": unsubscribeDoc.flatMap { (value: UnsubscribeDoc) -> ResultMap in value.resultMap }])
    }

    public var unsubscribeDoc: UnsubscribeDoc? {
      get {
        return (resultMap["unsubscribeDoc"] as? ResultMap).flatMap { UnsubscribeDoc(unsafeResultMap: $0) }
      }
      set {
        resultMap.updateValue(newValue?.resultMap, forKey: "unsubscribeDoc")
      }
    }

    public struct UnsubscribeDoc: GraphQLSelectionSet {
      public static let possibleTypes = ["Document"]
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct FindDocument: GraphQLSelectionSet {
      ...
      public struct SubscribedUser: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, firstName: String, lastName: String, avatar: String? = nil) {
